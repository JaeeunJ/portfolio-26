...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $s(e,t,n){let r=new Float32Array(zs),i=new K(0,1,0);return new wo({name:`SphericalGaussianBlur`,defines:{n:zs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:nc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ec(){return new wo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:nc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function tc(){return new wo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:nc(),fragmentShader:`
	...
	`}var rc=class extends Qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new zi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,td=class{constructor(e){Ku(this,`renderer`,void 0),Ku(this,`sceneRT`,void 0),Ku(this,`cellRT`,void 0),Ku(this,`cellMaterial`,void 0),Ku(this,`compositeMaterial`,void 0),Ku(this,`quad`,void 0),Ku(this,`quadScene`,void 0),Ku(this,`quadCamera`,void 0),Ku(this,`atlas`,void 0),Ku(this,`cellsX`,1),Ku(this,`cellsY`,1),this.renderer=e,this.atlas=Zu(),this.sceneRT=new Qt(1,1,{minFilter:h,magFilter:h,depthBuffer:!0}),this.cellRT=new Qt(1,1,{minFilter:f,magFilter:f,depthBuffer:!1}),this.cellMaterial=new wo({defines:{SUPERSAMPLE:$.ascii.supersample},uniforms:{tScene:{value:this.sceneRT.texture},uCells:{value:new G(1,1)},uEdgeThreshold:{value:$.ascii.edgeThreshold},uLumaFloor:{value:$.ascii.lumaFloor},uRampGamma:{value:$.ascii.rampGamma}},vertexShader:Qu,fragmentShader:$u,depthTest:!1,depthWrite:!1,blending:0}),this.compositeMaterial=new wo({uniforms:{tCells:{value:this.cellRT.texture},tAtlas:{value:this.atlas},uCells:{value:new G(1,1)},uBackground:{value:new Y(Q.void)},uInkDark:{value:new Y(Q.mid)},uInkLight:{value:new Y(Q.white)},uTime:{value:0}},vertexShader:Qu,fragmentShader:ed,depthTest:!1,depthWrite:!1,blending:0}),this.quad=new bi(new po(2,2),this.cellMaterial),this.quad.frustumCulled=!1,this.quadScene=new Rn,this.quadScene.add(this.quad),this.quadCamera=new is(-1,1,1,-1,0,1)}setSize(e,t){let{cellSize:n,supersample:r}=$.ascii;this.cellsX=Math.max(1,Math.floor(e/n)),this.cellsY=Math.max(1,Math.floor(t/n)),this.sceneRT.setSize(this.cellsX*r,this.cellsY*r),this.cellRT.setSize(this.cellsX,this.cellsY),this.cellMaterial.uniforms.uCells.value.set(this.cellsX,this.cellsY),this.compositeMaterial.uniforms.uCells.value.set(this.cellsX,this.cellsY)}render(e,t){let{renderer:n}=this;this.compositeMaterial.uniforms.uTime.value=performance.now()/1e3,n.setRenderTarget(this.sceneRT),n.clear(),n.render(e,t),this.quad.material=this.cellMaterial,n.setRenderTarget(this.cellRT),n.clear(),n.render(this.quadScene,this.quadCamera),this.quad.material=this.compositeMaterial,n.setRenderTarget(null),n.clear(),n.render(this.quadScene,this.quadCamera)}dispose(){this.sceneRT.dispose(),this.cellRT.dispose(),this.cellMaterial.dispose(),this.compositeMaterial.dispose(),this.atlas.dispose(),this.quad.geometry.dispose()}},nd=$.streaks;function rd(e){return e-Math.floor(e)}function id(){return{angle:Math.random()*Math.PI*2,startRadius:nd.radiusMin+Math.random()*(nd.radiusMax-nd.radiusMin),depth:nd.depthMin+Math.random()*(nd.depthMax-nd.depthMin),lengthScale:.75+Math.random()*.55,phase:Math.random()}}function ad(e){let t=Array.from({length:nd.count},id),n=(nd.segments+1)*2,r=nd.count*n,i=new Float32Array(r*3),a=new Float32Array(r*3),o=[];for(let e=0;e<nd.count;e++){let t=e*n;for(let e=0;e<nd.segments;e++){let n=t+e*2;o.push(n,n+1,n+2,n+1,n+3,n+2)}}let s=new Mr;s.setAttribute(`position`,new _r(i,3)),s.setAttribute(`color`,new _r(a,3)),s.setIndex(o);let c=new bi(s,new ci({vertexColors:!0,transparent:!0,blending:2,depthWrite:!1,side:2}));c.frustumCulled=!1,e.add(c);let l=new K,u=new K,d=new K,f=new K,p=new K,m=new K,h=new K,g=new K,_=new Y(Q.white);function v(e,r,o,c,v){l.setFromMatrixColumn(o.matrixWorld,0),u.setFromMatrixColumn(o.matrixWorld,1),d.setFromMatrixColumn(o.matrixWorld,2).negate(),f.copy(c).transformDirection(o.matrixWorldInverse);let y=-f.z,b=y>1e-4?f.x/y:0,x=y>1e-4?f.y/y:0,S=Math.tan(Mt.degToRad(o.fov)/2);for(let s=0;s<nd.count;s++){let c=t[s],f=s*n,y=rd(e*nd.progressCycles+r*nd.timeCycles+c.phase),C=y<nd.dutyCycle,w=C?y/nd.dutyCycle:0,T=C?Math.sin(Math.PI*w)*v:0,{depth:E}=c,D=E*S,ee=D*o.aspect,O=c.startRadius+w*nd.sweep,k=Math.cos(c.angle)*O*ee,A=Math.sin(c.angle)*O*D,j=Math.hypot(k,A)||1e-4,M=k/j,N=A/j,P=Math.max(j*nd.lengthFactor*c.lengthScale,E*nd.minLengthPerDepth),F=E*nd.halfWidthPerDepth;p.copy(o.position).addScaledVector(d,E).addScaledVector(l,b*E+k).addScaledVector(u,x*E+A),m.set(0,0,0).addScaledVector(l,M).addScaledVector(u,N),h.set(0,0,0).addScaledVector(l,-N).addScaledVector(u,M);for(let e=0;e<=nd.segments;e++){let t=(e/nd.segments-.5)*P;g.copy(p).addScaledVector(m,t);let n=T*Math.sin(Math.PI*e/nd.segments)**.55*nd.opacity,r=f+e*2;for(let[e,t]of[[r,1],[r+1,-1]]){let r=e*3;i[r+0]=g.x+h.x*F*t,i[r+1]=g.y+h.y*F*t,i[r+2]=g.z+h.z*F*t,a[r+0]=_.r*n,a[r+1]=_.g*n,a[r+2]=_.b*n}}}s.attributes.position.needsUpdate=!0,s.attributes.color.needsUpdate=!0}function y(){s.dispose(),c.material.dispose()}return{update:v,dispose:y}}var od=new K(0,1,0),sd=[new K(0,0,0),new K(4,2,-60),new K(-5,-1,-125),new K(3,4,-190),new K(8,-2,-255),new K(-4,-5,-325),new K(-2,3,-400),new K(5,6,-480),new K(1,1,-560)],cd=[{t:.08,side:30,lift:4,radius:13,color:Hu.teal,detail:1,ring:!0},{t:.15,side:-24,lift:-10,radius:8,color:Hu.amber,detail:0},{t:.23,side:-46,lift:14,radius:18,color:Hu.magenta,detail:1},{t:.33,side:26,lift:-12,radius:19,color:Q.soft,shape:`cursor`},{t:.41,side:50,lift:20,radius:26,color:Hu.gold,detail:2},{t:.49,side:-28,lift:4,radius:13,color:Hu.rose,detail:0},{t:.57,side:46,lift:8,radius:16,color:Hu.violet,shape:`book`,yawOffset:.3},{t:.65,side:-46,lift:-18,radius:20,color:Hu.rose,shape:`heart`,faceBack:.15},{t:.72,side:34,lift:-8,radius:15,color:Hu.umber,detail:1,ring:!0,ringColor:Hu.ochre},{t:.8,side:-52,lift:8,radius:20,color:Hu.gold,shape:`hardhat`},{t:.88,side:40,lift:22,radius:20,color:Hu.teal,detail:2},{t:.95,side:-32,lift:-6,radius:14,color:Q.accent,detail:1}],ld=`
  precision mediump float;
  varying vec3 vPosition;
  uniform vec3 uNear;
  uniform vec3 uColA;
...
`;function pd(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(32,32,0,32,32,32);n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.18,`rgba(255,255,255,0.85)`),n.addColorStop(.5,`rgba(255,255,255,0.12)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,64,64);let r=new Bi(e);return r.generateMipmaps=!1,r.minFilter=h,r}function md(){let e=document.createElement(`canvas`);e.width=e.height=63;let t=e.getContext(`2d`),n=(e,n,r)=>{t.fillStyle=`rgba(255,255,255,${r})`,t.fillRect(e*9,n*9,9,9)};n(3,3,1);for(let[e,t]of[[1,0],[-1,0],[0,1],[0,-1]])n(3+e,3+t,.8),n(3+e*2,3+t*2,.5),n(3+e*3,3+t*3,.26);let r=new Bi(e);return r.generateMipmaps=!1,r.minFilter=f,r.magFilter=f,r}function hd(){let e=document.createElement(`canvas`);e.width=128,e.height=256;let t=e.getContext(`2d`);t.globalCompositeOperation=`lighter`;for(let e=0;e<56;e++){let n=e/55,r=256*(.78-n*.72),i=46.08*(1-n)**1.5,a=.62*(1-n)**1.2;if(i<.5)continue;let o=t.createRadialGradient(64,r,0,64,r,i);o.addColorStop(0,`rgba(255,255,255,${a})`),o.addColorStop(.45,`rgba(255,255,255,${a*.34})`),o.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=o,t.fillRect(0,0,128,256)}let n=new Bi(e);return n.generateMipmaps=!1,n.minFilter=h,n}function gd(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(64,64,0,64,64,64);n.addColorStop(0,`rgba(255,255,255,0.95)`),n.addColorStop(.22,`rgba(255,255,255,0.45)`),n.addColorStop(.55,`rgba(255,255,255,0.12)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,128,128);let r=new Bi(e);return r.generateMipmaps=!1,r.minFilter=h,r}var _d=1-.78;function vd(e,t,n,r,i,a,o,s,c){let l=new Float32Array(t*3),u=new K;for(let i=0;i<t;i++){e.getPointAt(Math.random(),u);let t=Math.random()*Math.PI*2,a=n+Math.random()*(r-n);l[i*3+0]=u.x+Math.cos(t)*a,l[i*3+1]=u.y+Math.sin(t)*a*.7,l[i*3+2]=u.z+(Math.random()-.5)*60}let d=new Mr;if(d.setAttribute(`position`,new _r(l,3)),c){let e=new Float32Array(t*3),n=new Y;for(let r=0;r<t;r++)n.set(c[Math.floor(Math.random()*c.length)]),e[r*3+0]=n.r,e[r*3+1]=n.g,e[r*3+2]=n.b;d.setAttribute(`color`,new _r(e,3))}let f=new Li(d,new Mi({size:a,map:i,color:new Y(o),vertexColors:!!c,transparent:!0,opacity:s,depthWrite:!1,blending:2,sizeAttenuation:!0}));return f.frustumCulled=!1,f}function yd(e,t){let n=new An;return n.add(new bi(new uo(e,2),t)),n.add(...bd(e,t)),n}function bd(e,t){let n=e*1.05,r=e*.4,i=e*.075,a=[new G(r,0),new G(i,n-i)];for(let e=1;e<=4;e++){let t=e/4*(Math.PI/2);a.push(new G(i*Math.cos(t),n-i+i*Math.sin(t)))}let o=new fo(a,6);return[-1,1].map(n=>{let r=new bi(o,t);return r.position.set(n*e*.54,e*.86,0),r.rotation.z=-n*.28,r.rotation.y=Math.PI/6,r})}function xd(e,t){let n=new An,r=e*1.3,i=e*1.15,a=e*.1,o=e*.07,s=new Eo({color:new Y(Q.white),emissive:new Y(Q.pale),emissiveIntensity:.45,flatShading:!0,roughness:.9,side:2});for(let e of[-1,1]){let c=new An,l=new bi(new Wi(r,a,i),t);l.position.x=e*r/2,c.add(l);let u=new bi(new Wi(r*.88,o,i*.88),s);u.position.set(e*r/2-e*r*.04,(a+o)/2,0),c.add(u),c.rotation.z=e*1,n.add(c)}n.rotation.x=.5,n.rotation.z=.1;let c=new An;return c.add(n),c}function Sd(e,t){let n=new Ca;n.moveTo(.5,.5),n.bezierCurveTo(.5,.5,.4,0,0,0),n.bezierCurveTo(-.6,0,-.6,.7,-.6,.7),n.bezierCurveTo(-.6,1.1,-.3,1.54,.5,1.9),n.bezierCurveTo(1.2,1.54,1.6,1.1,1.6,.7),n.bezierCurveTo(1.6,.7,1.6,0,1,0),n.bezierCurveTo(.7,0,.5,.5,.5,.5);let r=new so(n,{depth:1,bevelEnabled:!0,bevelSize:.08,bevelThickness:.12,bevelSegments:1,curveSegments:12});r.center(),r.computeBoundingBox();let i=new K;r.boundingBox.getSize(i);let a=e*2/i.y;r.scale(a,a,a);let o=new An,s=new bi(r,t);s.rotation.z=Math.PI,o.add(s);let c=new An;c.rotation.set(-.1,.12,0),c.add(o);let l=new An;return l.add(c),l}function Cd(e,t){let n=new Ca;n.moveTo(0,0),n.lineTo(0,-1.9),n.lineTo(.45,-1.45),n.lineTo(.78,-2.2),n.lineTo(1.15,-2.02),n.lineTo(.83,-1.3),n.lineTo(1.42,-1.22),n.closePath();let r=new so(n,{depth:.42,bevelEnabled:!0,bevelSize:.07,bevelThickness:.07,bevelSegments:2});r.center();let i=e*2/2.2;r.scale(i,i,i);let a=new An,o=new bi(r,t);return o.rotation.z=.22,a.add(o),a}function wd(e,t){let n=new An,r=new bi(new mo(e,20,12,0,Math.PI*2,0,Math.PI/2),t);n.add(r);let i=new bi(new Gi(e*1.38,e*1.38,e*.08,24,1,!1,0,Math.PI),t);i.scale.x=1.15,n.add(i);let a=new bi(new mo(e*1.05,18,10,0,Math.PI*2,0,Math.PI/2),t);a.scale.set(.09,1.07,1),n.add(a),n.rotation.x=-.12,n.rotation.z=.05;let o=new An;return o.add(n),o}function Td(e){let t=new Rn;t.background=new Y(Q.void);let n=new ts(62,e,.1,3e3),r=new na(sd,!1,`catmullrom`,.4),i=new wo({uniforms:{uNear:{value:new Y(Q.void)},uColA:{value:new Y(Q.slate)},uColB:{value:new Y(Q.slate).multiplyScalar(.55)},uColC:{value:new Y(Q.accent).multiplyScalar(.35)},uTime:{value:0}},vertexShader:fd,fragmentShader:ld,side:1,depthWrite:!1}),a=new bi(new mo(1400,32,24),i);a.frustumCulled=!1,t.add(a);let o=pd(),s=md(),c=vd(r,720,90,520,o,1.9,Q.soft,.8),l=vd(r,330,90,520,o,1.9,Q.accent,.55),u=vd(r,170,26,120,o,.8,Q.accent,.4),d=vd(r,70,70,460,s,5,Q.white,.3,[Q.soft,Q.soft,Q.accent]);t.add(c,l,u,d);let f=[],p=[],m=[],h=[],g=[],_=[],v=new K,y=new K,b=new K,x=new K;for(let e of cd){r.getPointAt(e.t,b),r.getTangentAt(e.t,v),y.crossVectors(v,od).normalize();let n=new Eo({color:new Y(e.color),flatShading:!0,roughness:.95,metalness:0,side:2}),i=b.clone().addScaledVector(y,e.side);i.y+=e.lift;let a=[];if(e.shape&&e.shape!==`sphere`){let o={cat:yd,book:xd,heart:Sd,cursor:Cd,hardhat:wd}[e.shape](e.radius,n);o.position.copy(i),r.getPointAt(Math.max(e.t-(e.faceBack??.09),0),x),o.rotation.y=Math.atan2(x.x-i.x,x.z-i.z)+(e.yawOffset??0),t.add(o),m.push(o),a.push(o);let s=[];if(o.traverse(e=>{if(e instanceof bi){let t=e.material;t.transparent=!0,t.opacity=0,s.push(t)}}),h.push({group:o,t:e.t,materials:s}),e.shape===`book`||e.shape===`cursor`||e.shape===`hardhat`){let t=new $n;o.children.forEach(e=>t.expandByObject(e)),_.push({key:e.shape,object:o,topY:Number.isFinite(t.max.y)?t.max.y:e.radius,t:e.t,materials:s})}}else{let r=new bi(new uo(e.radius,e.detail??1),n);r.position.copy(i),r.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,0),t.add(r),f.push(r),a.push(r)}if(e.ring){let n=new Y(e.ringColor??Q.pale),r=new bi(new ho(e.radius*1.8,e.radius*.05,6,72),new Eo({color:n,flatShading:!0,roughness:.8,emissive:n,emissiveIntensity:.4}));r.position.copy(i),r.rotation.set(Math.PI/2.4,.3,0),t.add(r),p.push(r),a.push(r)}g.push({spec:e,right:y.clone(),parts:a})}let S=$.earth,C=r.getPointAt(1,new K),w=r.getTangentAt(1,new K),T=C.clone().addScaledVector(w,S.lead),E=new wo({uniforms:{uOcean:{value:new Y(Q.electric)},uLand:{value:new Y(Hu.leaf)},uLightDirection:{value:new K(-1,.8,.4).normalize()},uReveal:{value:0}},vertexShader:dd,fragmentShader:ud}),D=new bi(new mo(S.radius,48,32),E);D.position.copy(T),t.add(D);let ee=new K().crossVectors(w,od).normalize(),O=new K().crossVectors(ee,w).normalize(),k=new K().addScaledVector(w,-1).addScaledVector(ee,.3).addScaledVector(O,.2).normalize(),A=T.clone().addScaledVector(k,S.radius*.94),j=$.ball,M=new bi(new uo(j.radius,3),new Eo({color:new Y(Q.white),emissive:new Y(Q.soft),emissiveIntensity:1.4,roughness:.3,flatShading:!0}));t.add(M);let N=j.aura,P=gd(),F=new Qr(new Rr({map:P,color:new Y(Q.soft),transparent:!0,opacity:N.haloOpacity,depthWrite:!1,blending:2}));F.scale.setScalar(j.radius*N.haloScale),t.add(F);let te=hd(),ne=new Qr(new Rr({map:te,color:new Y(Q.soft),transparent:!0,opacity:0,depthWrite:!1,blending:2}));ne.center.set(.5,_d);let re=j.radius*N.tailWidth;ne.scale.set(re,re*2,1),t.add(ne);let ie=new rs(new Y(Q.accent),1100,280,2);t.add(ie);let ae=ad(t);t.add(new ss(new Y(Q.mid),1.2));let oe=new os(new Y(Q.white),6);oe.position.set(-1,.8,.4),t.add(oe);let se=new os(new Y(Q.accent),2);se.position.set(1,-.5,-.6),t.add(se);let I=new K,L=new K,ce=new K,le=new K,ue=new K,de=new K,fe=new K,pe=new K,me=new K;function he(e,t){let n=Mt.clamp(e,0,1)*.94,i=Math.min(n+j.lead,1);r.getPointAt(i,t),r.getTangentAt(i,v),le.crossVectors(v,od).normalize(),ue.crossVectors(le,v).normalize();let a=e*j.orbitTurns+j.orbitStartPhase,o=j.orbitRadius+Math.sin(e*Math.PI*3)*j.orbitWobble;t.addScaledVector(le,Math.cos(a)*o),t.addScaledVector(ue,Math.sin(a)*o*j.verticalFactor);let s=Mt.clamp((e-$.crashFrom)/($.impactAt-$.crashFrom),0,1);return s>0&&t.lerp(A,s*s*s),t}let ge=new K,_e=new K,ve=new K;for(let{spec:e,right:t,parts:n}of g){if(n.length===0)continue;n[0].updateMatrixWorld(!0),_e.copy(n[0].position);let r=0;for(let e of n)e.updateMatrixWorld(!0),e.traverse(e=>{if(!(e instanceof bi))return;let t=e.geometry.getAttribute(`position`);for(let n=0;n<t.count;n++)ve.fromBufferAttribute(t,n).applyMatrix4(e.matrixWorld),r=Math.max(r,ve.distanceTo(_e))});let i=r+j.radius+7,a=(e.t-j.lead)/.94,o=[];for(let e=0;e<=40;e++){let t=a+(e/40-.5)*.16;t<0||t>1||o.push(he(t,ge).clone())}let s=0;for(let n=0;n<8;n++){let n=1/0;for(let e of o)n=Math.min(n,e.distanceTo(_e));if(n>=i)break;s+=i-n,_e.addScaledVector(t,Math.sign(e.side)*(i-n))}if(s!==0)for(let r of n)r.position.addScaledVector(t,Math.sign(e.side)*s)}let ye=0,be=0,xe=0;function Se(e,t){F.position.copy(M.position),ne.position.copy(M.position);let r=(t-be)/1e3;if(r>0&&r<.5){let t=Math.abs(e-ye)/r;xe=Mt.lerp(xe,t,N.speedSmoothing)}ye=e,be=t;let i=Mt.clamp(xe/N.speedForFullStretch,0,1),a=i*i;ne.material.opacity=N.tailOpacity*a,ne.scale.y=re*2*Mt.lerp(N.tailRestLength,N.tailMaxLength,a),he(Math.max(e-N.directionSample,0),de),pe.copy(M.position).applyMatrix4(n.matrixWorldInverse),me.copy(de).applyMatrix4(n.matrixWorldInverse);let o=me.x-pe.x,s=me.y-pe.y;o*o+s*s>1e-6&&(ne.material.rotation=Math.atan2(-o,s))}function Ce(e,t,o=0){let s=Mt.clamp(e,0,1),c=s*.94;r.getPointAt(c,I),r.getPointAt(Math.min(c+.035,1),L),n.position.copy(I),ce.copy(L).sub(I).normalize();let l=Math.sin(s*Math.PI*2*$.rollCycles)*$.maxRoll+s*.12;n.up.set(0,1,0).applyAxisAngle(ce,l),n.lookAt(L),n.updateMatrixWorld(),he(s,M.position),M.rotation.x=t*4e-4,M.rotation.y=t*6e-4,ie.position.copy(M.position),Se(s,t),r.getTangentAt(c,fe);let u=Mt.clamp(xe/(N.speedForFullStretch*.6),0,1);ae.update(s,t*.001,n,fe,Math.min(1,u+o));for(let e=0;e<f.length;e++)f[e].rotation.y+=9e-4+e*4e-5;for(let e of p)e.rotation.z+=4e-4;for(let e=0;e<m.length;e++)m[e].position.y+=Math.sin(t*4e-4+e)*.006;for(let e of h){let t=Mt.smoothstep(c,e.t-.3,e.t-.14);e.group.visible=t>.001;for(let n of e.materials)n.opacity=t}let d=Mt.smoothstep(s,S.revealFrom,S.revealTo);D.visible=d>.001,E.uniforms.uReveal.value=d,D.rotation.y=t*$.earth.spin,i.uniforms.uTime.value=t*.001,a.position.copy(I)}function we(e){n.aspect=e,n.updateProjectionMatrix()}function Te(){t.traverse(e=>{if(e instanceof bi||e instanceof Li){e.geometry.dispose();let t=e.material;Array.isArray(t)?t.forEach(e=>e.dispose()):t.dispose()}}),ae.dispose(),o.dispose(),s.dispose(),te.dispose(),P.dispose()}return{scene:t,camera:n,ball:M,tagAnchors:_,update:Ce,setAspect:we,dispose:Te}}var Ed=[`-`,`\\`,`|`,`/`],Dd=`ui-monospace, SFMono-Regular, Menlo, monospace`;function Od(e){let{sizeMin:t,sizeMax:n}=$.warp,r=[];for(let i=0;i<e;i++){let a=i/e*Math.PI*2+(Math.random()-.5)*.4,o=Math.round((a%Math.PI+Math.PI)%Math.PI/Math.PI*4)%4;r.push({angle:a,glyph:Ed[o],radius:.06+Math.random()*.94,glyphs:4+Math.floor(Math.random()*10),size:t+Math.random()*(n-t),alpha:.4+Math.random()*.6,phase:Math.random(),speed:.6+Math.random()*.9})}return r}function kd(e){let t=e.getContext(`2d`);if(!t)return{setSize(){},render(){},fadeOut(){},dispose(){}};let n=t,r=Od($.warp.lines),i=Q.void,a=1,o=1,s=1,c=0,l=0,u=!1,d=0,f=1,p=0,m=0,h=0;function g(t,n){s=Math.min(window.devicePixelRatio,2),a=t,o=n,e.width=Math.round(t*s),e.height=Math.round(n*s),e.style.width=`${t}px`,e.style.height=`${n}px`}function _(e,t,u){if(n.setTransform(s,0,0,s,0,0),n.clearRect(0,0,a,o),c=t,l=u,t<=.001&&u<=.001)return;let d=a/2,f=o/2,p=Math.hypot(d,f),m=t**1.15,h=e*75e-5;n.fillStyle=`#ffffff`,n.textAlign=`center`,n.textBaseline=`middle`;for(let e of r){let r=(e.radius+h*e.speed+e.phase)%1,i=(.04+r*(.32+.68*(1-m*.55)))*p,a=Math.cos(e.angle),o=Math.sin(e.angle),s=e.size*(.7+.5*m),c=Math.max(1,Math.round(e.glyphs*(.25+.75*m))),l=s*.62;n.font=`${s.toFixed(1)}px ${Dd}`;let u=e.alpha*Math.sqrt(t)*(.12+r*1.4);for(let t=0;t<c;t++){let r=i+t*l,s=1-t/c*.65;n.globalAlpha=Math.min(u*s,1),n.fillText(e.glyph,d+a*r,f+o*r)}}u>.001&&(n.globalAlpha=Math.min(u,1),n.fillStyle=i,n.fillRect(0,0,a,o)),n.globalAlpha=1}function v(e){let t=Math.min((e-d)/f,1),n=1-(1-t)**2;_(e,p*(1-n),m*(1-n)),t<1?h=requestAnimationFrame(v):(u=!1,_(e,0,0))}return{setSize:g,render(e,t,n){u||_(e,t,n)},fadeOut(e){c<=.001&&l<=.001||(cancelAnimationFrame(h),u=!0,f=Math.max(e,1),d=performance.now(),p=c,m=l,h=requestAnimationFrame(v))},dispose(){cancelAnimationFrame(h)}}}function Ad(){let e=document.getElementById(`ascii-stage`),t=document.getElementById(`intro-scroll`),n=document.getElementById(`hero-pin`),r=document.getElementById(`intro-progress-bar`),i=document.getElementById(`scroll-nudge`),a=document.getElementById(`nudge-swap`),o=document.getElementById(`nudge-scroll`),s=document.getElementById(`nudge-incoming`),c=document.getElementById(`nudge-percent`),l=document.querySelector(`#break-orbit`),u=document.getElementById(`impact-flash`),d=document.querySelector(`#warp-canvas`);return!e||!t||!n||!r||!i||!u||!d||!a||!o||!s||!c||!l?null:{stage:e,spacer:t,heroPin:n,progressBar:r,nudge:i,nudgeSwap:a,nudgeScroll:o,nudgeIncoming:s,nudgePercent:c,breakOrbit:l,flash:u,warpCanvas:d}}function jd(e){e.stage.style.display=`none`,e.spacer.style.display=`none`,e.nudge.style.display=`none`,e.progressBar.style.display=`none`,e.flash.style.display=`none`,e.heroPin.style.opacity=``,document.body.classList.add(`intro-done`),window.scrollTo(0,0)}function Md(){let e=Ad();e&&Nd(e)}function Nd(e){if(e.spacer.style.height=`${$.scrollLengthVh}vh`,window.matchMedia(`(prefers-reduced-motion: reduce)`).matches){jd(e);return}let t;try{t=new Vu({antialias:!1,powerPreference:`high-performance`})}catch{jd(e);return}t.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.toneMapping=4,t.toneMappingExposure=1.05,e.stage.appendChild(t.domElement);let n=Td(window.innerWidth/window.innerHeight),r=new td(t),i=kd(e.warpCanvas),a=window.innerHeight;function o(){let e=window.innerWidth,o=window.innerHeight;a=o,t.setSize(e,o),r.setSize(e,o),i.setSize(e,o),n.setAspect(e/o)}o();let s=0,c=0,l=!1,u=!1,d=0,f=0,p=()=>Math.max(e.spacer.offsetHeight-a,1),m=()=>e.spacer.offsetHeight;function h(){s=Mt.clamp(window.scrollY/p(),0,1)}let g=!1,_=!1,v=0;function y(){v++,g=!1}function b(e,t,n={}){let{force:r=!1,onDone:i}=n,a=++v;g=!0,_=!1;let o=window.scrollY,s=e-o,c=performance.now(),l=-1;function u(e){if(a!==v)return;if(!r&&_){g=!1;return}if(!r&&l>=0&&Math.abs(window.scrollY-l)>2){g=!1;return}let n=Math.min((e-c)/t,1),d=n<.5?4*n*n*n:1-(-2*n+2)**3/2;window.scrollTo(0,o+s*d),l=window.scrollY,n<1?requestAnimationFrame(u):(g=!1,i?.())}requestAnimationFrame(u)}let x=!1,S=0,C=new Set([`ArrowDown`,`ArrowUp`,`PageDown`,`PageUp`,`Home`,`End`,` `,`Spacebar`]),w=()=>e.heroPin.offsetTop;function T(e){if(!l||x||e<=0)return!1;let t=window.scrollY-w();return t>e?!1:(t>0&&window.scrollTo(0,w()),k(),!0)}let E=!1,D=!1,ee=0;function O(){window.clearTimeout(ee),!(!E||D)&&(ee=window.setTimeout(A,$.exit.offerMs))}function k(){E||(E=!0,e.breakOrbit.classList.add(`is-offered`)),O()}function A(){window.clearTimeout(ee),E&&(E=!1,e.breakOrbit.classList.remove(`is-offered`))}function j(){D=!0,window.clearTimeout(ee)}function M(){D=!1,O()}e.breakOrbit.addEventListener(`pointerenter`,j),e.breakOrbit.addEventListener(`pointerleave`,M),e.breakOrbit.addEventListener(`focus`,j),e.breakOrbit.addEventListener(`blur`,M);function N(){A(),l=!1,document.body.classList.remove(`intro-done`),i.fadeOut($.warp.exitMs),e.stage.style.opacity=`1`,e.progressBar.style.opacity=`1`,e.spacer.style.height=`${$.scrollLengthVh}vh`,window.scrollTo(0,0),h(),c=s,ie=!0,oe=!1,u&&(u=!1,requestAnimationFrame(z))}function P(e){if(x){(!l||e.deltaY<=0)&&e.preventDefault();return}e.deltaY>=0||T(-e.deltaY)&&e.preventDefault()}let F=0;function te(e){F=e.touches[0]?.clientY??0}function ne(e){let t=e.touches[0]?.clientY??0,n=t-F;if(F=t,x){(!l||n>=0)&&e.preventDefault();return}n<=0||T(n*2)&&e.preventDefault()}let re=new Set([`ArrowUp`,`PageUp`,`Home`]);e.breakOrbit.addEventListener(`click`,()=>{!l||x||N()}),window.addEventListener(`wheel`,P,{passive:!1}),window.addEventListener(`touchstart`,te,{passive:!0}),window.addEventListener(`touchmove`,ne,{passive:!1}),window.addEventListener(`keydown`,e=>{if(x&&C.has(e.key)&&(!l||re.has(e.key))){e.preventDefault();return}if(re.has(e.key)&&T($.exit.keyStep)){e.preventDefault();return}e.key===`ArrowDown`||e.key===` `?window.scrollBy(0,220):e.key===`ArrowUp`&&window.scrollBy(0,-220)});let ie=!0;function ae(){if(!(x||l)){if(!ie){s<$.commitRearmAt&&(ie=!0);return}s<$.commitAt||(x=!0,ie=!1,window.clearTimeout(S),b(m(),$.commitDuration,{force:!0}))}}let oe=!1,se=0;function I(){h(),l&&!x&&window.scrollY<w()?(window.scrollTo(0,w()),h(),k()):l&&window.scrollY>w()+$.exit.offerHideBelow&&A()}function L(e){!$.autoAdvance||g||(oe&&s<$.autoAdvanceRearmAt&&(oe=!1),!(oe||s<$.autoAdvanceAt)&&(e-se<2500||(se=e,oe=!0,b(m(),$.autoAdvanceDuration))))}let ce=!1,le=-1,ue=0,de=0;function fe(){let t=e.nudgePercent.textContent;e.nudgePercent.textContent=`100%`,de=e.nudgeIncoming.scrollWidth,e.nudgePercent.textContent=t,ue=e.nudgeScroll.scrollWidth,e.nudgeSwap.style.width=`${ce?de:ue}px`}function pe(t){t!==ce&&(ce=t,e.nudgeScroll.classList.toggle(`is-hidden`,t),e.nudgeIncoming.classList.toggle(`is-hidden`,!t),e.nudgeSwap.style.width=`${t?de:ue}px`)}fe(),document.fonts?.ready.then(fe).catch(()=>{});let me={x:0,y:0,targetX:0,targetY:0};window.addEventListener(`mousemove`,e=>{me.targetX=e.clientX/window.innerWidth*2-1,me.targetY=-(e.clientY/window.innerHeight)*2+1},{passive:!0}),document.addEventListener(`mouseleave`,()=>{me.targetX=0,me.targetY=0});let he=new Map;document.querySelectorAll(`#scene-tags .scene-tag`).forEach(e=>{e.dataset.tag&&he.set(e.dataset.tag,e)});let ge=new K,_e=new K,ve=new K,ye=new Map,be=new Map,xe=new Map,Se=0,Ce=0,we=!1,Te=!1,Ee=0,De=0,Oe=new K,ke=new K,Ae=new K,R=new K;function je(){n.camera.getWorldDirection(ve);let e=c<Se-4e-4;Se=c;let t=performance.now(),r=Ce?Math.min((t-Ce)/1e3,.05):1/60;Ce=t;let i=1-.82**(r*60),a=window.innerWidth,o=window.innerHeight;n.ball.getWorldPosition(Oe),ke.copy(Oe),ke.y+=$.ball.radius,Ae.copy(Oe).project(n.camera),R.copy(ke).project(n.camera);let s=(Ae.x*.5+.5)*a,l=(-Ae.y*.5+.5)*o,u=Math.abs(l-(-R.y*.5+.5)*o),d=Math.max(l-u-64,90),f=s>a*.55,p=!1;for(let t of n.tagAnchors){let r=he.get(t.key);if(!r)continue;t.object.getWorldPosition(ge),_e.copy(ge).project(n.camera);let o=n.camera.position.distanceTo(ge),c=ve.dot(ge.clone().sub(n.camera.position))>10&&o<210&&Math.abs(_e.x)<.95&&Math.abs(_e.y)<.86,l=t.materials.length===0||t.materials[0].opacity>.55,m=c&&l&&o<150&&Math.abs(_e.x)<.68&&Math.abs(_e.y)<.52,h=ye.get(t.key)??!1;m?h=!0:e&&(h=!1),ye.set(t.key,h);let g=c&&h;if(g&&(p=!0),r.classList.toggle(`is-near`,g),!c){be.delete(t.key);continue}g||xe.set(t.key,f);let _=xe.get(t.key)??!1;r.classList.toggle(`is-flip`,_);let v=Math.min(Math.max(s+(_?-1:1)*(u+72),170),a-170),y=be.get(t.key);y?(y.x+=(v-y.x)*i,y.y+=(d-y.y)*i):(y={x:v,y:d},be.set(t.key,y)),r.style.transform=`translate3d(${y.x.toFixed(1)}px, ${y.y.toFixed(1)}px, 0)`}Te=p}let Me=new K,Ne=new Nt;function z(t){if(u)return;requestAnimationFrame(z);let a=f===0?1/60:Math.min((t-f)/1e3,.25);f=t;let o=$.warp.washFrom+.75*($.flashTo-$.warp.washFrom),p=1-(1-(x&&c>=o?$.commitSmoothing:$.scrollSmoothing))**(a*60);Ee+=((Te&&!x?1:0)-Ee)*(1-.88**(a*60)),De+=a*1e3*(1-.7*Ee),c=Mt.lerp(c,s,p*(1-.8*Ee)),Math.abs(c-s)<4e-4&&(c=s),n.update(c,De,Ee),L(t),ae();let h=window.scrollY>=m();l&&!h&&(document.body.classList.remove(`intro-done`),l=!1);let g=Math.min(Math.max((c-$.flashFrom)/($.flashTo-$.flashFrom),0),1),_=Math.min(Math.max((c-$.warp.washFrom)/($.flashTo-$.warp.washFrom),0),1);if(i.render(t,g,_),e.stage.style.opacity=`1`,e.heroPin.style.opacity=`0`,e.progressBar.style.opacity=String(1-g),h){if(d===0&&(d=t),c>=$.flashTo||t-d>2e3){l=!0,e.stage.style.opacity=``,e.heroPin.style.opacity=``,e.progressBar.style.opacity=``,e.nudge.style.opacity=``,document.body.classList.add(`intro-done`),y(),e.spacer.style.height=`0px`,window.scrollTo(0,0),x=!0,window.clearTimeout(S),S=window.setTimeout(()=>{x=!1},$.landSettleMs),i.fadeOut($.warp.settleMs),u=!0;return}}else d=0;if(e.progressBar.style.width=`${c*100}%`,pe(c>$.nudgeSwitchAt),document.body.classList.toggle(`title-away`,c>$.nudgeSwitchAt),ce){let t=Math.min(c/$.impactAt,1),n=Math.round(t*100);n!==le&&(le=n,e.nudgePercent.textContent=`${n}%`)}e.nudge.style.opacity=String(1-g),Fe();let{parallax:v}=$;if(v.enabled){Me.copy(n.camera.position),Ne.copy(n.camera.quaternion),me.x=Mt.lerp(me.x,me.targetX,v.smoothing),me.y=Mt.lerp(me.y,me.targetY,v.smoothing);let e=Math.min(c/.3,1),t=Mt.lerp(v.horizontalMin,v.horizontalMax,e);n.camera.translateX(me.x*t),n.camera.translateY(me.y*v.vertical),n.camera.rotateY(-me.x*v.rotation),r.render(n.scene,n.camera),je(),n.camera.position.copy(Me),n.camera.quaternion.copy(Ne)}else r.render(n.scene,n.camera),je();we||(we=!0,window.setTimeout(()=>document.body.classList.add(`booted`),550))}let Pe=document.getElementById(`hud8-fill`),B=document.getElementById(`hud8-pct`),V=-1;function Fe(){let e=Math.round(Math.min(c/$.impactAt,1)*100);e!==V&&(V=e,Pe&&(Pe.style.width=`${Math.round(e/10)*10}%`),B&&(B.textContent=`%${e}`))}function Ie(){x||g&&(_=!0)}window.addEventListener(`wheel`,Ie,{passive:!0}),window.addEventListener(`touchstart`,Ie,{passive:!0}),window.addEventListener(`keydown`,Ie),window.addEventListener(`scroll`,I,{passive:!0});let Le=0;window.addEventListener(`resize`,()=>{window.clearTimeout(Le),Le=window.setTimeout(o,120)}),h(),c=s,requestAnimationFrame(z),requestAnimationFrame(()=>{window.scrollY===0&&b(p()*.02,1100)})}var Pd=e=>String(e).padStart(2,`0`);function Fd(){let e=document.getElementById(`hud-time`);if(!e)return;let t=0;function n(){let r=new Date;e.textContent=`${Pd(r.getHours())}:${Pd(r.getMinutes())}:${Pd(r.getSeconds())}`,t=window.setTimeout(n,1e3-Date.now()%1e3)}n(),document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`visible`&&(window.clearTimeout(t),n())})}var Id=`ui-monospace, SFMono-Regular, Menlo, monospace`,Ld=`.:-=+*#%@`,Rd=[`#            `,`##           `,`#.#          `,`#..#         `,`#...#        `,`#....#       `,`#.....#      `,`#......#     `,`#.......#    `,`#........#   `,`#.........#  `,`#.......###  `,`#..#...#     `,`#.# #...#    `,`##  #...#    `,`     #...#   `,`     #...#   `,`      #...#  `,`      #####  `],zd=[`   ##        `,`  #..#       `,`  #..#       `,`  #..#       `,`  #..#       `,`  #..#       `,`  #..######  `,`  #.......#  `,`  #.......#  `,` #........#  `,`#.........#  `,`#.........#  `,`#.........#  `,` #........#  `,` #........#  `,`  #......#   `,`  #......#   `,`  ########   `],Bd=2;function Vd(e,t,n){let r=[],i=[];for(let t=0;t<e.length;t++){let n=e[t],a=0;for(;a<n.length;){let e=n[a],o=1;for(;a+o<n.length&&n[a+o]===e;)o++;e===`#`?r.push([a,t,o]):e===`.`&&i.push([a,t,o]),a+=o}}return{outline:r,fill:i,hotspotCol:t,hotspotRow:n}}var Hd={arrow:Vd(Rd,0,0),hand:Vd(zd,3,0)},Ud={step:11,lifeMs:520,sizeMin:8.5,sizeMax:15,speedForFullRamp:2.2,drift:6,max:64},Wd=350,Gd=`a, button, [role="button"], [data-cursor-target]`;function Kd(e,t,n){return e+(t-e)*n}function qd(){let e=document.getElementById(`cursor-layer`),t=e?.querySelector(`canvas`);if(!e||!(t instanceof HTMLCanvasElement))return;let n=e,r=t;if(!window.matchMedia(`(hover: hover) and (pointer: fine)`).matches)return;let i=r.getContext(`2d`);if(!i)return;let a=i,o=window.matchMedia(`(prefers-reduced-motion: reduce)`),s=1,c=1,l=1,u=-100,d=-100,f=-100,p=-100,m=0,h=!1,g=!1,_=!1,v=[],y=0,b=0;function x(){l=Math.min(window.devicePixelRatio,2),s=window.innerWidth,c=window.innerHeight,r.width=Math.round(s*l),r.height=Math.round(c*l),r.style.width=`${s}px`,r.style.height=`${c}px`}function S(e){if(o.matches)return;let t=u-f,n=d-p,r=Math.hypot(t,n);if(r<Ud.step)return;let i=r/Math.max(e-m,1),a=Math.min(i/Ud.speedForFullRamp,1),s=Ld[Math.min(Math.round(a*8),8)],c=Kd(Ud.sizeMin,Ud.sizeMax,a),l=Math.min(Math.floor(r/Ud.step),Ud.max);for(let i=1;i<=l;i++){let a=i*Ud.step/r,o=Math.random()*Math.PI*2;v.push({x:f+t*a,y:p+n*a,char:s,size:c,born:e,driftX:Math.cos(o)*Ud.drift,driftY:Math.sin(o)*Ud.drift})}v.length>Ud.max&&v.splice(0,v.length-Ud.max),f=u,p=d,m=e}function C(e){a.textAlign=`center`,a.textBaseline=`middle`;for(let t=v.length-1;t>=0;t--){let n=v[t],r=(e-n.born)/Ud.lifeMs;if(r>=1){v.splice(t,1);continue}let i=(1-r)**3;a.globalAlpha=i*.85,a.font=`${(n.size*(.75+.25*(1-r))).toFixed(1)}px ${Id}`;let o=n.x+n.driftX*r,s=n.y+n.driftY*r;a.lineWidth=2.5,a.strokeStyle=`rgba(7, 7, 15, 0.5)`,a.strokeText(n.char,o,s),a.fillStyle=Q.accent,a.fillText(n.char,o,s)}a.globalAlpha=1}function w(e,t,n){for(let[r,i,o]of e)a.fillRect(t+r*Bd,n+i*Bd,o*Bd,Bd)}function T(){let e=h?Hd.hand:Hd.arrow,t=g?2:0,n=Math.round(u)-e.hotspotCol*Bd+t,r=Math.round(d)-e.hotspotRow*Bd+t;a.fillStyle=Q.void,w(e.outline,n,r),a.fillStyle=g?Q.white:Q.pale,w(e.fill,n,r)}function E(e){y=0,a.setTransform(l,0,0,l,0,0),a.clearRect(0,0,s,c),_?(C(e),T()):v.length=0,v.length>0&&(b=e),_&&e-b<Wd&&D()}function D(){y||(y=requestAnimationFrame(E))}function ee(e){let t=performance.now();_||(_=!0,f=e.clientX,p=e.clientY,m=t,n.classList.add(`is-visible`)),u=e.clientX,d=e.clientY,S(t);let r=e.target;h=r instanceof Element&&r.closest(Gd)!==null,b=t,D()}function O(){_=!1,h=!1,g=!1,n.classList.remove(`is-visible`),D()}function k(e){g=e,b=performance.now(),D()}x(),document.body.classList.add(`has-custom-cursor`),window.addEventListener(`resize`,x),window.addEventListener(`pointermove`,ee,{passive:!0}),window.addEventListener(`pointerdown`,()=>k(!0),{passive:!0}),window.addEventListener(`pointerup`,()=>k(!1),{passive:!0}),document.addEventListener(`pointerleave`,O),window.addEventListener(`blur`,O)}Md(),Fd(),qd();function Jd(){history.scrollRestoration=`manual`,window.scrollTo(0,0),location.reload()}window.addEventListener(`keydown`,e=>{e.shiftKey&&(e.key===`R`||e.key===`r`)&&Jd()}),document.getElementById(`play-again`)?.addEventListener(`click`,Jd);